...
@call %1 rosetta\priority-queue
@call %1 rosetta\tree-traversal
...
@call %1 rosetta\aliquot-sequence-classifications -rosetta\aliquot.in
@call %1 rosetta\Gaussian-elimination
@call %1 rosetta\prime-decomposition
